    ...
    <div class="container mx-auto px-4">
      <div class="flex flex-col md:flex-row justify-between items-center">
        ...
        <div class="flex space-x-6">
          <a href="https://www.instagram.com/djummmmm/" class="text-gray-400 hover:text-white transition">
          ...
          <a href="https://www.facebook.com/djumad.bantan.5" class="text-gray-400 hover:text-white transition">
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <a href="https://github.com/djumad" class="text-gray-400 hover:text-white transition">
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
